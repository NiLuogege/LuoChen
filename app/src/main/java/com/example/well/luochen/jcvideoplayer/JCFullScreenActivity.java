...
public class JCFullScreenActivity extends Activity {
    ...
    public static void startActivity(Context context, String url, Class videoPlayClass, Object... obj) {
        CURRENT_STATE = com.example.well.luochen.jcvideoplayer.JCVideoPlayer.CURRENT_STATE_NORMAL;
        URL = url;
    ...
    private com.example.well.luochen.jcvideoplayer.JCVideoPlayer mJcVideoPlayer;
    /**
     * 刚启动全屏时的播放状态
     */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mJcVideoPlayer.mIfFullscreenIsDirectly) {
            ...
            com.example.well.luochen.jcvideoplayer.JCVideoPlayer.IF_RELEASE_WHEN_ON_PAUSE = true;
            com.example.well.luochen.jcvideoplayer.JCMediaManager.instance().setListener(mJcVideoPlayer);
            if (CURRENT_STATE == com.example.well.luochen.jcvideoplayer.JCVideoPlayer.CURRENT_STATE_PAUSE) {
                com.example.well.luochen.jcvideoplayer.JCMediaManager.instance().mediaPlayer.seekTo(com.example.well.luochen.jcvideoplayer.JCMediaManager.instance().mediaPlayer.getCurrentPosition());
            }
        }
    }
    ...
    protected void onPause() {
        super.onPause();
        com.example.well.luochen.jcvideoplayer.JCVideoPlayer.releaseAllVideos();
//        finish();
    }
}
