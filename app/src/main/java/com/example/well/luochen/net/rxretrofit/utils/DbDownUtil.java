package com.example.well.luochen.net.rxretrofit.utils;
...
import com.example.well.rxjavaandretrofit_doctor.net.rxretrofit.gen.DaoMaster;
import com.example.well.rxjavaandretrofit_doctor.net.rxretrofit.gen.DaoSession;
...
public class DbDownUtil {
    ...
    private static class InstenceHolder{
        public static final DbDownUtil  db = new DbDownUtil();
    }
}
