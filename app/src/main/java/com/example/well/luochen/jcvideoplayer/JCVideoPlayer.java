package com.example.well.luochen.jcvideoplayer;
...
public abstract class JCVideoPlayer extends FrameLayout implements View.OnClickListener, View.OnTouchListener, SeekBar.OnSeekBarChangeListener, JCMediaManager.JCMediaPlayerListener, TextureView.SurfaceTextureListener {
    ...
    private int position = -1;//如果是-1就是没有视频播放
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.start) {
            ...
            if (mCurrentState == CURRENT_STATE_NORMAL || mCurrentState == CURRENT_STATE_ERROR) {
                if (!mUrl.startsWith("file") && !com.example.well.luochen.jcvideoplayer.JCUtils.isWifiConnected(getContext()) && !WIFI_TIP_DIALOG_SHOWED) {
                    showWifiDialog();
                    return;
                }
                startButtonLogic();
            ...
            switch (event.getAction()) {
                ...
                case MotionEvent.ACTION_MOVE:
                    ...
                    if (mChangePosition) {
                        ...
                        String seekTime = com.example.well.luochen.jcvideoplayer.JCUtils.stringForTime(mSeekTimePosition);
                        String totalTime = com.example.well.luochen.jcvideoplayer.JCUtils.stringForTime(totalTimeDuration);
    ...
    protected void setProgressAndTime(int progress, int secProgress, int currentTime, int totalTime) {
        ...
        currentTimeTextView.setText(com.example.well.luochen.jcvideoplayer.JCUtils.stringForTime(currentTime));
        totalTimeTextView.setText(com.example.well.luochen.jcvideoplayer.JCUtils.stringForTime(totalTime));
    }

    protected void resetProgressAndTime() {
        progressBar.setProgress(0);
        progressBar.setSecondaryProgress(0);
        currentTimeTextView.setText(com.example.well.luochen.jcvideoplayer.JCUtils.stringForTime(0));
        totalTimeTextView.setText(com.example.well.luochen.jcvideoplayer.JCUtils.stringForTime(0));
    }
