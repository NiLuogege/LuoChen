...
import com.example.well.luochen.net.rxretrofit.download.DownLoadListener.DownloadProgressListener;
import com.example.well.luochen.net.rxretrofit.download.DownState;
import com.example.well.luochen.net.rxretrofit.download.HttpDownManager;
import com.example.well.luochen.net.rxretrofit.listener.HttpDownOnNextListener;
import com.example.well.luochen.net.rxretrofit.utils.DbDownUtil;
